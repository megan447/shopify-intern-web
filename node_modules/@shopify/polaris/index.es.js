...
function Button$1(_ref) {
  ...
  var iconMarkup = icon && isIconSource(icon) ? createElement(
    'span',
    { className: styles$5.Icon },
...
var ResourceList$1 = function (_React$Component) {
    ...
    _createClass(ResourceList, [{
        ...
        value: function render() {
            ...
            var headerWrapperOverlay = loading ? createElement('div', { className: styles$70['HeaderWrapper-overlay'] }) : null;
            var headerMarkup = (showHeader || needsHeader) && listNode && itemsExist && createElement(
                ...
                createElement(
                    ...
                    function (isSticky) {
                        var headerClassName = classNames(styles$70.HeaderWrapper, sortOptions && sortOptions.length > 0 && styles$70['HeaderWrapper-hasSort'], _this3.selectable && styles$70['HeaderWrapper-hasSelect'], loading && styles$70['HeaderWrapper-disabled'], _this3.selectable && selectMode && styles$70['HeaderWrapper-inSelectMode'], isSticky && styles$70['HeaderWrapper-isSticky']);
                        return createElement(
                            'div',
            ...
            var resourceListClassName = classNames(styles$70.ResourceList, loading && styles$70.disabledPointerEvents);
