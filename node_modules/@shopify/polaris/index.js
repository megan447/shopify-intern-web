...
function Button$1(_ref) {
  ...
  var iconMarkup = icon && isIconSource(icon) ? React.createElement(
    'span',
    { className: styles$5.Icon },
...
var INPUT = _EditableTargets.INPUT;
var TEXTAREA = _EditableTargets.TEXTAREA;
var SELECT = _EditableTargets.SELECT;
var CONTENT_EDITABLE = _EditableTargets.CONTENT_EDITABLE;
...
var ResourceList$1 = function (_React$Component) {
    ...
    _createClass(ResourceList, [{
        ...
        value: function render() {
            ...
            var headerWrapperOverlay = loading ? React.createElement('div', { className: styles$70['HeaderWrapper-overlay'] }) : null;
            var headerMarkup = (showHeader || needsHeader) && listNode && itemsExist && React.createElement(
                ...
                React.createElement(
                    ...
                    function (isSticky) {
                        var headerClassName = styles.classNames(styles$70.HeaderWrapper, sortOptions && sortOptions.length > 0 && styles$70['HeaderWrapper-hasSort'], _this3.selectable && styles$70['HeaderWrapper-hasSelect'], loading && styles$70['HeaderWrapper-disabled'], _this3.selectable && selectMode && styles$70['HeaderWrapper-inSelectMode'], isSticky && styles$70['HeaderWrapper-isSticky']);
                        return React.createElement(
                            'div',
            ...
            var spinnerSize = items.length === 1 ? 'small' : 'large';
            ...
            var resourceListClassName = styles.classNames(styles$70.ResourceList, loading && styles$70.disabledPointerEvents);
